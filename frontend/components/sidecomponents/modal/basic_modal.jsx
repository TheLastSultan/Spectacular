  ...
  render() {    
    ...
    <div className= "form-answer-container">
        ...
        <div className="form-answer">
            ...
            <button onClick={this.handleInput("faceShape","Wide")} className="quiz-btn btn btn-outline-secondary btn-sm"> average </button> 
    ...
    return (
      <div className="modal-container">
        ...
        <div className= "close-icon">
            <FontAwesomeIcon icon="window-close" className="faWindowClose"  size="3x" onClick={this.closeModal}/>
        </div>
